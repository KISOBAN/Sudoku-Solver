...
int main() {
    // Write C code here
char board[9][9] = {"53..7....","6..195...",".98....6.","8...6...3","4..8.3..1", "7...2...6",".6....28.","...419..5","....8..79"}; //example board

char board2[9][9] = {"53..7....","6..195...",".98....6.","8...6...3","4..8.3..1", "7...2...6",".6....28.","...419..5","....8..79"}; // another example board
